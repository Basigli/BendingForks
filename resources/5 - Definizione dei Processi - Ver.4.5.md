...
Seleziona il personale da coinvolgere nel team di progetto, stabilisce le regole
...
8. Risk Management
9.
10. Stakeholder Management (inserita a partire dalla 5a edizione)
...
Contempla le attività necessarie per garantire il rispetto del piano di qualità
(i.e., l’impiego dei processi previsti nel Quality Planning) e che i requisiti di
...
Impact Priority Mitigate

Available HW/SW technology limits scope

New technology does not integrate with old
...
Integrating technologies impacts schedule

TC01

TC02

Unexpected need to acquire hardware

Unexpected need to acquire software

Quality

TQ01

Technology limits solution performance
...
Senior scope change request too significant
...
Interproject dependencies compromise schedule

Task duration estimates too optimistic
...
La Stakeholder Analysis è una tecnica per raccogliere e analizzare in modo
sistematico informazioni quantitative e qualitative per determinare quali
interessi dovrebbero essere considerati nel progetto.

Identifica gli interessi, le aspettative e l’influenza degli stakeholder e li mette
in relazione con gli obiettivi del progetto.

Identifica anche le possibili interrelazioni tra gli stakeholder e il progetto,
per trarre vantaggio da potenziali “coalizioni” e partnership e aumentare le
