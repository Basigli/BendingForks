...
Durante le JPPS il personale coinvolto nel progetto definisce le attività che
devono essere svolte per soddisfare i requisiti espressi dal committente (che
dovrebbero soddisfare i suoi bisogni) entro i vincoli di tempo, di budget e di
risorse disponibili.
...
“facilitatore” esperto, che teoricamente dovrebbe essere un mediatore
imparziale tra chi gestirà e svilupperà il progetto e il committente.

Project manager
Il project manager avrà la responsabilità sul completamento con successo
del progetto, quindi si deve concentrare sulla fattibilità del piano. Il project
manager deve negoziare un piano che consenta di fornire il business value
atteso rispettando i vincoli di tempo, budget e risorse fissati.

Another project manager
Può essere il rappresentante del committente per verificare il lavoro del
project manager. Inoltre, se non si dispone di un facilitatore, sarebbe
...
progetti con la metodologia che si intende impiegare.

Technographer
Con il termine “technographer” Wysocki identifica un professionista, con
ottime competenze di project management e sull’uso di strumenti software
di supporto al project management, che si occupa della rendicontazione
...
successo della fase di pianificazione.
Il project team sarà impegnato nell’esecuzione del progetto, pertanto il
suo contributo è fondamentale nella stima della durata delle attività e
nella previsione delle risorse necessarie.

Client rappresentative
Non sempre il cliente è disposto a “investire” risorse per supportare la
fase di pianificazione. Comunque, la partecipazione del committente alla
fase di pianificazione è fortemente consigliata.
Quando si dovrà far fronte a dei cambiamenti (solitamente attesi), sarà
...
progetti attivi e sulla effettiva disponibilità nel tempo delle risorse che
sono presenti all’interno dell’organizzazione.

Functional managers
Solitamente i manager funzionali sono responsabili di aree che possono
fornire gli input o ricevere degli output dai deliverables del progetto.
...
owner, che “detengono” i processi da supportare con la soluzione fornita
dal progetto.

Project champion
Il project champion (anche detto project advocate, “a person who fights or
argues for a cause or on behalf of someone else”) non deve essere confuso
con il project sponsor, che ha un coinvolgimento formale nel progetto.
Il project champion solitamente è una persona carismatica con ottime
competenze tecniche e/o organizzative.
Per Wysocki il project champion è colui che “vende” il progetto al senior
management. Questo ruolo può essere ricoperto da un rappresentante del
...
Planning tool
Nella fase di pianificazione la WBS fornisce al team una rappresentazione
dettagliata del progetto come un insieme di attività da completate per
terminare con successo il progetto.
Al livello di massimo dettaglio delle attività fornito dalla WBS possono
essere effettuate le stime relative al lavoro da svolgere (effort), la durata
(elapsed time) e le risorse necessarie.

Project status reporting tool
La WBS può essere utilizzata per monitorare lo stato di completamento
...
In definitiva si può stabilire che la WBS è ancora instabile e incompleta, ma
che al momento non si può ottenere nulla di meglio.
In questi casi è necessario scegliere dei modelli PMLC che permettano di
...
Outflow Inflow Tot. Outflow Tot. Net Cash Flow Note
...
: Expected duration
E
: Earliest Start (il primo tempo utile per iniziare il task)
ES
: Latest Start (l’ultimo tempo utile per iniziare il task)
LS
: Earliest Finish (il primo tempo utile per finire il task)
EF
LF
: Latest Finish (l’ultimo tempo utile per finire il task)
Slack : Slack time (ritardo massimo che non causa un ritardo nel
...
Per ogni task, scrivere sul Post-It il suo ID, il nome e la durata.
Posizionare il Post-It sulla parte destra della lavagna (whiteboard).
Posizionare lo start node sulla parte sinistra della lavagna.
...
(anche detto float) che rappresenta il massimo ritardo che può subire il
...
La compressione della schedula non è mai gratis!!!
