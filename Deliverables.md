...
1. **Approccio utilizzato**: in questo documento dovrà essere
descritto come si è scelto di gestire il progetto, giustificando ogni scelta
effettuata e illustrando tutta la documentazione di progetto che verrà
allegata. Ci si aspetta di trovare tutti gli aspetti relativi alla fase di:
    - Scoping/Initiating:
    ...
    Si suggerisce di fornire anche un indice del materiale allegato.
    
    Per quel che riguarda i meeting previsti si chiede di documentare
    l’ordine del giorno, i partecipanti e una sintesi dell’ipotetico
    svolgimento.
    
2. **Documentazione di Progetto**: l’insieme dei documenti di progetto che
